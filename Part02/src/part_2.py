...
def plot(start_node, goal_node, x_path, y_path, N_list, S_list):
    figure, axes = plt.subplots()
    axes.set(xlim=(0, 6), ylim=(0, 2))

    circle1 = matplotlib.patches.Circle((4, 1.1), radius=0.5, fill=True)

    box1 = matplotlib.patches.Rectangle((1.5, 0.75), width=0.15, height=1.25, color='red')
    box2 = matplotlib.patches.Rectangle((2.5, 0), width=0.15, height=1.25, color='yellow')
